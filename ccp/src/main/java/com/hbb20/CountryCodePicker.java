...
public class CountryCodePicker extends RelativeLayout {
    ...
    static int LIB_DEFAULT_COUNTRY_CODE = 45;
    ...
    private void init(AttributeSet attrs) {
        ...
        imageViewFlag = (CircleImageView) holderView.findViewById(R.id.image_flag);
...
//            ccpPadding = (int) a.getDimension(R.styleable.CountryCodePicker_ccp_padding, context.getResources().getDimension(R.dimen.ccp_padding));
            ...
            setDialogBackground(a.getResourceId(R.styleable.CountryCodePicker_ccpDialog_backgroundColor, 0));
